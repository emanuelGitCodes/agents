...
def main():
    ...
    tools = [
        ...
        {
            "type": "function",
            "function": opening_savings_account_or_checking_account_json,
        },
    ...
    def chat(message, history):
        system_prompt = (
            f"You are a helpful assistant providing support services to immigrants new to the United States. \
    ...
    WELCOME = (
        "Welcome to the Alpha Centauri Immigrant Support Center! \n"
