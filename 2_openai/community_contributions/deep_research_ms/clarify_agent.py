...
class ClarifyingQuestion(BaseModel):
    reason: str = Field(
        description="Your reasoning for why this question is important to the research and initial query."
    )
    question: str = Field(
        description="The question that will be sent to the user to facilitate subsequent research."
    )


class ClarifyingQuestions(BaseModel):
    clarifiers: list[ClarifyingQuestion] = Field(
        description="A list of questions that will facilitate better research."
    )
