...
class ReportEvaluation(BaseModel):
    is_approved: bool = Field(
        description="Is this report high-quality, accurate, well-structured, and ready to be sent to a client?"
    )
    revisions_needed: str = Field(
        description="Specific, actionable feedback and revisions for the writer. Be very critical."
    )
