...
class SearchEvaluation(BaseModel):
    is_sufficient: bool = Field(
        description="Are the search results high-quality and comprehensive enough to write a 1000-word report?"
    )
    missing_topics: list[str] = Field(
        description="A list of specific topics that are missing or need more detail."
    )
